...
(meditations
  ...
  (= (str "First comes love, "
     ...
     ((fn [[a b c]] (format "First comes %s, then comes %s, then comes Clojure with the baby carriage" a b c))
  ...
  (= "Rich Hickey aka The Clojurer aka Go Time aka Macro Killah"
     (let [[first-name last-name & aliases]
       ...
       (format "%s %s%s" first-name last-name (apply str (map #(str " aka " %) aliases)))))
